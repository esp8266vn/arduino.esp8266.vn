...
``WiFiServer``, ``WiFiClient``, và ``WiFiUDP`` thực hiện theo cùng một cách như khung thư viện WiFi. Có bốn ví dụ được làm mẫu cho thư viện này. Bạn có thể xem chi tiết các lệnh ở đây : `http://www.arduino.cc/en/Reference/WiFi`_

.. _`http://www.arduino.cc/en/Reference/WiFi`: https://www.arduino.cc/en/Reference/WiFi
